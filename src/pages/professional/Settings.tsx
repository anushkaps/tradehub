                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500">Receive email notifications for new job opportunities, messages, and updates.</p>
                      </div>
                    </div>
            ...
            {activeTab === 'payment' && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">Manage your payment methods for subscription and receiving payments.</p>
                </div>
