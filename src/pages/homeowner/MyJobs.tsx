...
const MyJobs: React.FC = () => {
      ...
      try {
        ...
        const transformed = (data || []).map(
          (job: any): Job => ({
            ...
            professional: job.professional?.[0] || undefined,
  ...
  const filteredJobs = jobs.filter(
    (job) =>
      ...
      job.trade_type.toLowerCase().includes(searchTerm.toLowerCase())
  );
            ...
            >
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <span className="ml-2">{job.trade_type}</span>
                </div>
                {job.status === "open" && (
                  <div className="mb-4">
                    ...
                    <div className="flex items-center">
                      <div className="h-8 w-8 rounded-full bg-gray-300 flex items-center justify-center text-white mr-2">
                        {job.professional.avatar_url ? (
                          <img
                            src={job.professional.avatar_url}
                            alt="Pro"
                      ...
                      <span>
                        {job.professional.first_name}{" "}
                        {job.professional.last_name}
                      </span>
                    </div>
                  </div>
                )}
