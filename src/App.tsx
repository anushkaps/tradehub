  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        <Link
          to="/"
          className="bg-[#105298] text-white px-6 py-3 rounded-md hover:bg-[#0a407a] transition-colors"
        >
          Go Back Home
        </Link>
      </div>
          ...
          <UserProvider>
            <Layout>
              ...
              <Routes>
                ...
                <Route
                  path="/help/advice-and-inspiration"
                  element={<AdviceAndInspiration />}
                />
                ...
                {/* Email confirmation & password reset */}
                <Route
                  path="/auth/please-confirm-email"
                  element={<PleaseConfirmEmail />}
                />
                <Route
                  path="/homeowner/email-confirmed"
                  element={<HomeownerEmailConfirmedCallback />}
                />
                <Route
                  path="/professional/email-confirmed"
                  element={<ProfessionalEmailConfirmedCallback />}
                />
                <Route
                ...
                <Route
                  path="/homeowner/login-otp"
                  element={<HomeownerLoginOTP />}
                />
                <Route
                  path="/homeowner/login-otp-callback"
                  element={<HomeownerLoginOTP />}
                />

                {/* Public Homeowner */}
                <Route
                  path="/homeowner/hiring-guide"
                  element={<HiringGuide />}
                />
                ...
                />
                <Route
                  path="/professional/login-otp"
                  element={<ProfessionalLoginOTP />}
                />
                <Route
                  path="/professional/login-otp-callback"
                  element={<ProfessionalLoginOTP />}
                />

                {/* Public Professional */}
                <Route
                  path="/professional/how-it-works"
                  element={<ProfessionalHowItWorks />}
                />
                ...
                <Route
                  path="/h/:username"
                  element={<PublicHomeownerProfile />}
                />
                <Route
                  path="/p/:username"
